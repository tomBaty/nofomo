    ...
    return (
        window.innerWidth < 600 ? (
            <div id='navbar'>
                ...
                <div id='favouritesToggle' onClick={onToggleFavourites}>
                    {heartIcon}
                </div>

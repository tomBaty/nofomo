...
export const Exhibit = memo(function Exhibit({ data, isExpanded, isFavourite, isVisited, onExpand, onCollapse, onFavouriteToggle, onVisitToggle, userProfile, onExhibitUpdate, reviews, onReviewSubmitted, onShowReviews }) {
    ...
    const reviewSummary = useMemo(() => getReviewSummary(reviews, data.id), [reviews, data.id]);
                ...
                <div className='title_section'>
                    <div>
                        ...
                        <div className='exhibit_meta'>
                            ...
                            {reviewSummary && (
                                <p className='exhibit-review-summary'>
                                    <span className='exhibit-review-stars'>{reviewSummary.stars}</span>
                                    <span className='exhibit-review-count'>({reviewSummary.count})</span>
                                </p>
                            )}
                        </div>
                    </div>
